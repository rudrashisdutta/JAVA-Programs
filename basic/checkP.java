 ...
 * 
 * There are two random variables. First one is the days one-> 0-353
 * 
 * The second one is-> The seeded Random values are'nt the b'days. They are
 * Unique people.
 * 
 * 
 * 
 * Possible Conclusion-> seeded Random sequences Do not have duplicate values in
 * them.
 */